Shader "Gradient/Single Texture/Diamond/Single-Color/To Transparent/Inverted UV/Alpha Blend" {
	...
	SubShader {
		...
		Pass {
			...
			fixed4 frag(VertexToFragment i) : COLOR {
				...
				return tex * fixed4(lerp(fixed4(_Color.rgb,0),_Color,abs(i.uv2.x)+abs(i.uv2.y)+_Offset ));	//Output textured diamond gradient
			}
