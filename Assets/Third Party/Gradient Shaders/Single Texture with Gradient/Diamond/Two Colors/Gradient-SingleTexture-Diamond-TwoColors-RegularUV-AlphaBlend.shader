Shader "Gradient/Single Texture/Diamond/Two Colors/Regular UV/Alpha Blend" {
	...
	SubShader {
		...
		Pass {
			...
			fixed4 frag(VertexToFragment i) : COLOR {
				...
				return tex * fixed4(lerp(_Color,_Color2,abs(i.uv2.x)+abs(i.uv2.y)+_Offset ));	//Output textured diamond gradient
			}
