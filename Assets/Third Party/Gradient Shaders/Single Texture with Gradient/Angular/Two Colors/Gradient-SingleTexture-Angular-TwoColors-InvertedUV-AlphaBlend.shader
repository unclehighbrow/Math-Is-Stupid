Shader "Gradient/Single Texture/Angular/Two Colors/Inverted UV/Alpha Blend" {
	...
	SubShader {
		...
		Pass {
			...
			fixed4 frag(VertexToFragment i) : COLOR {
				...
				return tex * fixed4(lerp(_Color2,_Color,(atan2(i.uv2.y,i.uv2.x)*0.1591549)+0.5 ));	//Output textured angular gradient (0.1591549 is 1.0/(2*PI))
			}
