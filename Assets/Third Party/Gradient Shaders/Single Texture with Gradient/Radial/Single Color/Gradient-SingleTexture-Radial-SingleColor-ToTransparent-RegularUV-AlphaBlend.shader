Shader "Gradient/Single Texture/Radial/Single-Color/To Transparent/Regular UV/Alpha Blend" {
	...
	SubShader {
		...
		Pass {
			...
			fixed4 frag(VertexToFragment i) : COLOR {
				...
				return tex * fixed4(lerp(_Color,fixed4(_Color.rgb,0),sqrt( (i.uv2.x*i.uv2.x)+(i.uv2.y*i.uv2.y) )+_Offset ));	//Output textured radial gradient
			}
