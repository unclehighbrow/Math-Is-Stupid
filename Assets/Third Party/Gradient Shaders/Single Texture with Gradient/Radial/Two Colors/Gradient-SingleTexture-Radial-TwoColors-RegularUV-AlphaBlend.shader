Shader "Gradient/Single Texture/Radial/Two Colors/Regular UV/Alpha Blend" {
	...
	SubShader {
		...
		Pass {
			...
			fixed4 frag(VertexToFragment i) : COLOR {
				...
				return tex * fixed4(lerp(_Color,_Color2,sqrt( (i.uv2.x*i.uv2.x)+(i.uv2.y*i.uv2.y) )+_Offset ));	//Output textured radial gradient
			}
