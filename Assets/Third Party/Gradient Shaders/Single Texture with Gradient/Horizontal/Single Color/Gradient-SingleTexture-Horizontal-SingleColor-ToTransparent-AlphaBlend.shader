Shader "Gradient/Single Texture/Horizontal/Single-Color/To Transparent/Alpha Blend" {
	...
	SubShader {
		...
		Pass {
			...
			VertexToFragment vert(AppData v) {
				...
				//o.uv = v.texcoord.xy;
				v.texcoord1.xy = half2((v.texcoord1.x+_UVXOffset)*_UVScale,(v.texcoord1.y+_UVYOffset)*_UVScale);
			...
			fixed4 frag(VertexToFragment i) : COLOR {
				...
				return tex * fixed4(lerp(_Color,fixed4(_Color.rgb,0),abs(i.uv2.x)));	//Output textured horizontal gradient
			}
