Shader "Gradient/Single Texture/Vertical/Single-Color/To Transparent/Alpha Blend" {
	...
	SubShader {
		...
		Pass {
			...
			fixed4 frag(VertexToFragment i) : COLOR {
				...
				return tex * fixed4(lerp(_Color,fixed4(_Color.rgb,0),abs(i.uv2.y)));	//Output textured vertical gradient
			}
