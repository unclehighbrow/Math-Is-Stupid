Shader "Gradient/No Texture/Diamond/Two Colors/Inverted UV/Solid Blend" {
	...
	SubShader {
		...
		Pass {
			...
			fixed4 frag(VertexToFragment i) : COLOR {
				return fixed4(lerp(_Color2,_Color,abs(i.uv.x)+abs(i.uv.y)+_Offset ));	//Output diamond gradient
			}
