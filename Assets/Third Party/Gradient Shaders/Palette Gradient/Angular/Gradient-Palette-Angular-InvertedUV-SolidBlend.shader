Shader "Gradient/Palette/Angular/Inverted UV/Solid Blend" {
	...
	SubShader {
		...
		Pass {
			...
			fixed4 frag(VertexToFragment i) : COLOR {
				return tex2D(_PaletteTex, half2(lerp(1.0,0,(atan2(i.uv.y,i.uv.x)*0.1591549)+0.5),0) );	//Output paletted angular gradient (0.1591549 is 1.0/(2*PI))
			}
