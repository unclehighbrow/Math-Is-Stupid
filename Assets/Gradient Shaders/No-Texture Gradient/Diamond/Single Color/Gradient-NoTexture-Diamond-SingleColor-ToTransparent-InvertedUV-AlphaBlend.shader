Shader "Gradient/No Texture/Diamond/Single-Color/To Transparent/Inverted UV/Alpha Blend" {
	...
	SubShader {
		...
		Pass {
			...
			fixed4 frag(VertexToFragment i) : COLOR {
				return fixed4(lerp(fixed4(_Color.rgb,0),_Color,abs(i.uv.x)+abs(i.uv.y)+_Offset ));	//Output diamond gradient
			}
