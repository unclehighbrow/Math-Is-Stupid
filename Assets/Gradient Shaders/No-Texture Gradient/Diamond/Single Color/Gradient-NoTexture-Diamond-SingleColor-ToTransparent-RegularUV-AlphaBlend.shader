Shader "Gradient/No Texture/Diamond/Single-Color/To Transparent/Regular UV/Alpha Blend" {
	...
	SubShader {
		...
		Pass {
			...
			fixed4 frag(VertexToFragment i) : COLOR {
				return fixed4(lerp(_Color,fixed4(_Color.rgb,0),abs(i.uv.x)+abs(i.uv.y)+_Offset ));	//Output diamond gradient
			}
