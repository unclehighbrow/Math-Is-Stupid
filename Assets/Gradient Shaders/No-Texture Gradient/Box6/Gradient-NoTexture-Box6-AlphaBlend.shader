Shader "Gradient/No Texture/Box6/Alpha Blend" {
	...
	SubShader {
		...
		Pass {
			...
			fixed4 frag(VertexToFragment i) : COLOR {
				...
				fixed4 mid2=lerp(left,right,i.uv.x+_EdgeOffset);	//Interpolate bottom
				fixed4 blended=lerp(mid2,mid,i.uv.y);			//Find overall bottom
				return blended;				//Output Box6 blended gradient
			}
