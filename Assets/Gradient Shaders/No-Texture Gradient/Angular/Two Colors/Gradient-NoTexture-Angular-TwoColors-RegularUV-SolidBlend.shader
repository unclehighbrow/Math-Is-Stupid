Shader "Gradient/No Texture/Angular/Two Colors/Regular UV/Solid Blend" {
	...
	SubShader {
		...
		Pass {
			...
			fixed4 frag(VertexToFragment i) : COLOR {
				return fixed4(lerp(_Color,_Color2,(atan2(i.uv.y,i.uv.x)*0.1591549)+0.5 ));	//Output angular gradient (0.1591549 is 1.0/(2*PI))
			}
