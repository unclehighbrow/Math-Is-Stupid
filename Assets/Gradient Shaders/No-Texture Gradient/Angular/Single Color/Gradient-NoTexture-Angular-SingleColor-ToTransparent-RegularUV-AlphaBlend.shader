Shader "Gradient/No Texture/Angular/Single-Color/To Transparent/Regular UV/Alpha Blend" {
	...
	SubShader {
		...
		Pass {
			...
			fixed4 frag(VertexToFragment i) : COLOR {
				return fixed4(lerp(_Color,fixed4(_Color.rgb,0),(atan2(i.uv.y,i.uv.x)*0.1591549)+0.5 ));		//Output angular gradient (0.1591549 is 1.0/(2*PI))
			}
