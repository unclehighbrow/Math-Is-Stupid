Shader "Gradient/Single Texture/Diamond/Two Colors/Inverted UV/Alpha Blend" {
	...
	Properties {
		...
		_Offset ("Offset", float) = 0					//Receive input form a float
	}
	...
	SubShader {
		...
		Pass {
			...
			fixed4 frag(VertexToFragment i) : COLOR {
				...
				return tex * fixed4(lerp(_Color2,_Color,abs(i.uv2.x)+abs(i.uv2.y)+_Offset ));	//Output textured diamond gradient
			}
