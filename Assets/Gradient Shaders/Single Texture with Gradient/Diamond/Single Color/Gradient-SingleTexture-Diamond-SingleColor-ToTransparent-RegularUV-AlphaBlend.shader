Shader "Gradient/Single Texture/Diamond/Single-Color/To Transparent/Regular UV/Alpha Blend" {
	...
	//Z-Writing is Off and Z-Testing is Off
	//Color masking is RGBA and Culling is Off
	//Texture coords can be adjusted with Tiling and Offset in material
	...
	SubShader {
		...
		Pass {
			...
			fixed4 frag(VertexToFragment i) : COLOR {
				...
				return tex * fixed4(lerp(_Color,fixed4(_Color.rgb,0),abs(i.uv2.x)+abs(i.uv2.y)+_Offset ));	//Output textured diamond gradient
			}
