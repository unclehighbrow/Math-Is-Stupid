Shader "Gradient/Multi Palette/Vertical/Alpha Blend" {
	...
	SubShader {
		...
		Pass {
			...
			fixed4 frag(VertexToFragment i) : COLOR {
				fixed4 tex=tex2D(_PaletteTex, half2(lerp(0,1.0,abs(i.uv.y)),_PaletteRow) );	//Ouput paletted vertical gradient
				return tex;
			}
