Shader "Gradient/Multi Palette/Angular/Regular UV/Alpha Blend" {
	...
	SubShader {
		...
		Pass {
			...
			fixed4 frag(VertexToFragment i) : COLOR {
				fixed4 tex=tex2D(_PaletteTex, half2(lerp(0,1.0,(atan2(i.uv.y,i.uv.x)*0.1591549)+0.5),_PaletteRow) );	//Output paletted angular gradient (0.1591549 is 1.0/(2*PI))
				return tex;
			}
